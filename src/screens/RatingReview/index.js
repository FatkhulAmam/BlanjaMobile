...
import { StyleSheet, View, TouchableOpacity, ScrollView, CheckBox, Image } from 'react-native'
...
const Filter = ({navigation}) => {
    ...
    return (
        <>
            ...
            <View style={styles.parent}>
                ...
                <View style={styles.tag}>
                    ...
                    <View style={styles.checkContainer}>
                        ...
                        />
                        <Text style={styles.label} note>With Photo</Text>
                    </View>
                </View>
                <Card>
                    <CardItem>
            ...
            <View style={styles.btnCheck}>
            ...
            </View><ActionSheet styles={styles.actionSheet} ref={actionSheetRef}>
                ...
                <View>
                    ...
                    <View>
                        <Text style={styles.opinion}>Please Share Your Opinion About The Product</Text>
                    </View>
                    <View>
                        <Form>
                            <Textarea style={styles.textArea} rowSpan={5} bordered placeholder="Your Review" />
                        </Form>
                    </View>
