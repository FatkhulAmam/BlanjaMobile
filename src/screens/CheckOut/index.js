...
import { Header, Left, Body, Text, Title, Button, Card, CardItem } from 'native-base';
    ...
    return (
        <>
            ...
            <View style={styles.btnCheck}>
                ...
                <Button block style={styles.check} onPress={()=>navigation.navigate("Success")}><Text>Submit Order</Text></Button>
            </View>
        </>
    )
}
